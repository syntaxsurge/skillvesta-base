...
const catalog: CourseCatalogItem[] = [
  {
    ...
    tags: ['Solidity', 'Base', 'Tooling'],
    summary:
      'Hands-on introduction to Solidity, Hardhat, and secure smart-contract patterns for Base builders.'
  },
  {
    courseId: 2n,
    ...
    summary:
      'Blueprint and templates for crafting recurring-revenue membership products with Skillvesta infrastructure.'
  },
  {
    courseId: 3n,
